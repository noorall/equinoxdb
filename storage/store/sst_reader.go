...
func (t *TSMReader) ReadAt(entry *IndexEntry, vals []types.Value) ([]types.Value, error) {
	t.mu.RLock()
...
func (t *TSMReader) Read(key []byte, timestamp int64) ([]types.Value, error) {
	t.mu.RLock()
...
func (t *TSMReader) ReadAll(key []byte) ([]types.Value, error) {
	t.mu.RLock()
...
func (t *TSMReader) BatchDelete() BatchDeleter {
	t.deleteMu.Lock()
...
func (t *TSMReader) ReadFloatBlockAt(entry *IndexEntry, vals *[]types.FloatValue) ([]types.FloatValue, error) {
	t.mu.RLock()
...
func (t *TSMReader) ReadFloatArrayBlockAt(entry *IndexEntry, vals *types.FloatArray) error {
	t.mu.RLock()
...
func (t *TSMReader) ReadIntegerBlockAt(entry *IndexEntry, vals *[]types.IntegerValue) ([]types.IntegerValue, error) {
	t.mu.RLock()
...
func (t *TSMReader) ReadIntegerArrayBlockAt(entry *IndexEntry, vals *types.IntegerArray) error {
	t.mu.RLock()
...
func (t *TSMReader) ReadUnsignedBlockAt(entry *IndexEntry, vals *[]types.UnsignedValue) ([]types.UnsignedValue, error) {
	t.mu.RLock()
...
func (t *TSMReader) ReadUnsignedArrayBlockAt(entry *IndexEntry, vals *types.UnsignedArray) error {
	t.mu.RLock()
...
func (t *TSMReader) ReadStringBlockAt(entry *IndexEntry, vals *[]types.StringValue) ([]types.StringValue, error) {
	t.mu.RLock()
...
func (t *TSMReader) ReadStringArrayBlockAt(entry *IndexEntry, vals *types.StringArray) error {
	t.mu.RLock()
...
func (t *TSMReader) ReadBooleanBlockAt(entry *IndexEntry, vals *[]types.BooleanValue) ([]types.BooleanValue, error) {
	t.mu.RLock()
...
func (t *TSMReader) ReadBooleanArrayBlockAt(entry *IndexEntry, vals *types.BooleanArray) error {
	t.mu.RLock()

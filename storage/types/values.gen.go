...
func NewFloatArrayFromValues(v FloatValues) *FloatArray {
	a := NewFloatArrayLen(len(v))
	for i, val := range v {
...
func NewIntegerArrayFromValues(v IntegerValues) *IntegerArray {
	a := NewIntegerArrayLen(len(v))
	for i, val := range v {
		a.Timestamps[i] = val.unixNano
		a.Values[i] = val.value
	}
...
func NewUnsignedArrayFromValues(v UnsignedValues) *UnsignedArray {
	a := NewUnsignedArrayLen(len(v))
	for i, val := range v {
		a.Timestamps[i] = val.unixNano
		a.Values[i] = val.value
	}
...
func NewStringArrayFromValues(v StringValues) *StringArray {
	a := NewStringArrayLen(len(v))
	for i, val := range v {
		a.Timestamps[i] = val.unixNano
		a.Values[i] = val.value
	}
...
func NewBooleanArrayFromValues(v BooleanValues) *BooleanArray {
	a := NewBooleanArrayLen(len(v))
	for i, val := range v {
		a.Timestamps[i] = val.unixNano
		a.Values[i] = val.value
	}
